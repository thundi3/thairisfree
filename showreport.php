...
echo "<tr><td width=10%>Name</td><td width=30%>: ".$ptname."  ".$ptlastname."</td><td width=12%>Report Time</td><td width=48%>: ".EngEachDate($approvetime)."</td></tr>";
echo "<tr><td width=10%>Age</td><td width=30%>: ".AgeCal($AGE)."  Sex : ".$sex."</td><td width=12%>Exam Time</td><td width=48%>: ".EngEachDate($examtime)."</tr>";
